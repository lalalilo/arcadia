...
excerpt: Redux-saga is a widely used library that help to deal with side effects in a front-end app. Typing sagas properly is not obvious though. Here's a guide on how to do it!
---

_Redux-saga is a widely used library that help to deal with side effects in a front-end app. Typing sagas properly is not obvious though. Here's a guide on how to do it!_
